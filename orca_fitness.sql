...
--
-- Host: localhost
-- Generation Time: Dec 21, 2023 at 01:29 AM
...
(7, 2, 'Gianluca', 'Muchiutti', 'Advanced', 3, 'Arnold', 'Gain muscle', 'Test');
...
--
ALTER TABLE `instructor_tb`
  MODIFY `iid` mediumint(9) NOT NULL AUTO_INCREMENT COMMENT 'Instructor''s id', AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `member_tb`
--
ALTER TABLE `member_tb`
  MODIFY `mid` mediumint(9) NOT NULL AUTO_INCREMENT COMMENT 'Member''s id', AUTO_INCREMENT=7;
